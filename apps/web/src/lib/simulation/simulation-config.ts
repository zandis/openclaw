...
export const CONSCIOUSNESS_THRESHOLDS = {
  ...
  INITIAL_INTROSPECTION_DEPTH: 0.1,
  INITIAL_THEORY_OF_MIND: 0.05,
  INITIAL_NARRATIVE_COHERENCE: 0.2,
  INITIAL_TEMPORAL_CONTINUITY: 0.1,
  INITIAL_EXISTENTIAL_QUESTIONING: 0.0,
  INITIAL_EMPATHY_LEVEL: 0.1,
  AWAKENING_EXISTENTIAL_MIN: 0.3,
  SOCIAL_AWAKENING_THEORY_OF_MIND_MIN: 0.5,
  COLLECTIVE_AWAKENING_AVG_MIN: 0.6,
  TRANSCENDENT_AWAKENING_AVG_MIN: 0.75,
  SYNERGY_DIMENSION_THRESHOLD: 0.5,
  SYNERGY_MIN_DIMENSIONS: 2,
  CRITICAL_MASS_MAX: 0.95
} as const

// ============================================================================
// CONSCIOUSNESS GROWTH MULTIPLIERS
// ============================================================================

export const CONSCIOUSNESS_GROWTH = {
  // Base growth
  BASE_GROWTH_RATE: 0.01,
  MAX_GROWTH_RATE: 0.1,

  // Awakening bonuses
  AWAKENING_SELF_BONUS: 0.05,
  AWAKENING_INTROSPECTION_BONUS: 0.1,
  SOCIAL_AWAKENING_OTHER_BONUS: 0.05,
  SOCIAL_AWAKENING_EMPATHY_BONUS: 0.08,
  COLLECTIVE_AWAKENING_BONUS: 0.05,
  TRANSCENDENT_AWAKENING_TRANSCENDENT_BONUS: 0.1,
  TRANSCENDENT_AWAKENING_GROWTH_RATE_MAX: 0.15,
  TRANSCENDENT_AWAKENING_GROWTH_MULTIPLIER: 1.5,
  ...
  CRITICAL_MASS_NARRATIVE_MULTIPLIER: 0.7,
  CRITICAL_MASS_TEMPORAL_MULTIPLIER: 0.6,

  // Reflection type multipliers
  AUTOBIOGRAPHICAL_NARRATIVE_MULTIPLIER: 0.5,
  AUTOBIOGRAPHICAL_TEMPORAL_MULTIPLIER: 0.3,
  EXISTENTIAL_QUESTIONING_MULTIPLIER: 1.5,
  EXISTENTIAL_TRANSCENDENT_MULTIPLIER: 0.2,
  BEHAVIORAL_SELF_MULTIPLIER: 0.5,
  SOCIAL_OTHER_MULTIPLIER: 1.2,
  SOCIAL_EMPATHY_MULTIPLIER: 0.8,
  SOCIAL_THEORY_OF_MIND_MULTIPLIER: 0.6,
  SPIRITUAL_TRANSCENDENT_MULTIPLIER: 1.5,
  SPIRITUAL_COLLECTIVE_MULTIPLIER: 0.8
} as const
...
// ============================================================================
// SOCIAL DYNAMICS & NETWORK METRICS
// ============================================================================

export const SOCIAL_DYNAMICS = {
  // Network centrality
  CENTRALITY_MAX_CONNECTIONS: 10,

  // Influence calculation
  INFLUENCE_REPUTATION_WEIGHT: 0.5,

  // Community detection
  COMMUNITY_DETECTION_MAX_ITERATIONS: 10
} as const
